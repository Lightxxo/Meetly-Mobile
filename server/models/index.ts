...
db.Event.hasMany(db.EventAttendance, {
  foreignKey: "eventID",
  onDelete: "CASCADE",
});
db.EventAttendance.belongsTo(db.Event, {
  foreignKey: "eventID",
  onDelete: "CASCADE",
});

// User - EventAttendance (One-to-Many)
db.User.hasMany(db.EventAttendance, {
  foreignKey: "userID",
  onDelete: "CASCADE",
});
db.EventAttendance.belongsTo(db.User, {
  foreignKey: "userID",
  onDelete: "CASCADE",
});
...
db.Event.hasMany(db.EventTypeOfEvent, {
  foreignKey: "eventID",
  onDelete: "CASCADE",
});
db.EventTypeOfEvent.belongsTo(db.Event, { foreignKey: "eventID" });

db.EventType.hasMany(db.EventTypeOfEvent, {
  foreignKey: "eventTypeID",
  onDelete: "CASCADE",
});
